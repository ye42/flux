...
class AssetManager
{
    ...
    public function fluxJs() {
        return Flux::pro()
            ? $this->pretendResponseIsFile(__DIR__.'/../../flux-pro/dist/flux-lite.min.js', 'text/javascript')
            : $this->pretendResponseIsFile(__DIR__.'/../../flux/dist/flux.js', 'text/javascript');
    }

    public function fluxMinJs() {
        return Flux::pro()
            ? $this->pretendResponseIsFile(__DIR__.'/../../flux-pro/dist/flux-lite.min.js', 'text/javascript')
            : $this->pretendResponseIsFile(__DIR__.'/../../flux/dist/flux.min.js', 'text/javascript');
    }

    public function editorCss() {
        return $this->pretendResponseIsFile(__DIR__.'/../../flux/dist/editor.css', 'text/css');
    }

    public function editorJs() {
        return $this->pretendResponseIsFile(__DIR__.'/../../flux/dist/editor.js', 'text/javascript');
    }

    public function editorMinJs() {
        return $this->pretendResponseIsFile(__DIR__.'/../../flux/dist/editor.min.js', 'text/javascript');
    }
